...
# Arch A 4cls v2 — post-proceed router, 13626 examples, 2-GPU run
# Dataset: router_no_reason_v1_4cls (labels: reflect/replan/escalate/unsolvable)
# Output: sft_runs/outputs/router_arch_a_4cls_v2/
...
YAML=$WORKSPACE/sft_runs/router_arch_a_4cls_v2.yaml
