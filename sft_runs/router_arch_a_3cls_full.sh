...
# Arch A 3cls — Qwen3.5-4B FULL fine-tune (no LoRA, ZeRO-3 sharded)
...
YAML=/mnt/bn/ecom-govern-models/qijiahe/sft_runs/router_arch_a_3cls_full.yaml

# multi-GPU? set FORCE_TORCHRUN=1 before invoking llamafactory-cli, e.g.:
#   FORCE_TORCHRUN=1 bash router_arch_a_3cls_full.sh
