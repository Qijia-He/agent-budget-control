#!/bin/bash
#SBATCH --job-name=router_3cls_v6_v4meta_qwen3_4b_lora
...
# on the original Qwen3.5-4B run -- see SUMMARY.md). This run: Qwen3-4B LoRA.
...
llamafactory-cli train /path/to/agent-budget-control/sft_runs/qwen3_4b_lora.yaml
