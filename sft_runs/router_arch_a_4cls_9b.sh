...
# Arch A 4cls — Qwen3.5-9B LoRA variant (vs baseline 4B LoRA)
...
YAML=/mnt/bn/ecom-govern-models/qijiahe/sft_runs/router_arch_a_4cls_9b.yaml

# multi-GPU? set FORCE_TORCHRUN=1 before invoking llamafactory-cli, e.g.:
#   FORCE_TORCHRUN=1 bash router_arch_a_4cls_9b.sh
